...
--
-- Name: results_templates; Type: SCHEMA; Schema: -; Owner: -
--
...
CREATE EXTENSION IF NOT EXISTS postgis WITH SCHEMA geog;
...
--
-- Name: individual_results; Type: TABLE; Schema: results_templates; Owner: -
--
...
--
-- Name: results; Type: TABLE; Schema: results_templates; Owner: -
--
...
CREATE TABLE results_templates.results (
    ...
    CONSTRAINT check_rank_fields CHECK ((((rank).info IS NOT NULL) AND ((((rank).info = 'VAL'::racedata.rank_enum) AND ((rank).num IS NOT NULL)) OR ((rank).info <> 'VAL'::racedata.rank_enum))))
);


--
-- Name: timed; Type: TABLE; Schema: results_templates; Owner: -
--
...
--
-- Name: pointed; Type: TABLE; Schema: results_templates; Owner: -
--
...
--
-- Name: results results_pkey; Type: CONSTRAINT; Schema: results_templates; Owner: -
--

ALTER TABLE ONLY results_templates.results
...
--
-- Name: individual_results individual_results_rider_id_fkey; Type: FK CONSTRAINT; Schema: results_templates; Owner: -
--

ALTER TABLE ONLY results_templates.individual_results
    ADD CONSTRAINT individual_results_rider_id_fkey FOREIGN KEY (rider_id) REFERENCES racedata.riders(rider_id);


--
-- Name: results results_stage_id_fkey; Type: FK CONSTRAINT; Schema: results_templates; Owner: -
--
...
--
-- Name: results results_team_id_fkey; Type: FK CONSTRAINT; Schema: results_templates; Owner: -
--
